...
| [Acebook](https://github.com/GunelMC/acebook-runtime-terrors)                | A group project to produce a social media platform which included building Authentication and Authorisation system from scratch using Ruby on Rails.                                                                                                                                                   | 2 weeks               | Rails API, PostgreSQL, Bcrypt, Heroku, Rspec-rails(Shoulda-matchers), SimpleCov  |
