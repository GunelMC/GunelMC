...
| [Acebook](https://github.com/GunelMC/acebook-runtime-terrors)                | A group project to produce a social media platform using Ruby on Rails.                                                                                                                                                   | 2 weeks               | Rails API, PostgreSQL, Bcrypt, Heroku, Rspec-rails(Shoulda-matchers), SimpleCov  |
| [MakersBnB](https://github.com/GunelMC/Makers_BnB)                           | A team project to build an AirBnB clone including Authentication and Authorisation system from scratch.                                                                                                                   | 1 week                | Ruby, Sinatra, PostgreSQL, Bcrypt, Bootstrap, OOD, RSpec, Capybara               |
