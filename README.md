...
- Built a [single-page map application](https://github.com/GunelMC/betwixt) within 10 days using an entirely new library (React) and framework (Next.js) with only limited previous Javascript knowledge. Presentation demo [here at 18:55](https://www.youtube.com/watch?v=LFv_0LF3j-U).
