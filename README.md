...
| [Acebook](https://github.com/GunelMC/acebook-runtime-terrors)                | A group project to produce a social media platform using Ruby On Rails.                                                                                                                                                   | 2 weeks               | Rails API, Rspec-rails(Shoulda-matchers), Bootstrap, Database_cleaner, Heroku, SimpleCov |
| [MakersBnB](https://github.com/GunelMC/Makers_BnB)                           | A team project to build an AirBnB clone.                                                                                                                                                                                  | 1 week                | Ruby, Sinatra, CSS, OOD, RSpec, Capybara                                                 |
